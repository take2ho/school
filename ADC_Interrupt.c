...
void ADC_IRQHandler(void)
{
	...
	ADC_Value = ADC2->DR;		// Reading ADC result
        DIST =  -7.1265*(Voltage^3) + 47.346*(Voltage^2) - 108.86*Voltage + 97.681;
	...
	LCD_DisplayChar(1,12,Voltage%10 + 0x30);
        ...
        LCD_DisplayChar(2,9,DIST%100+ 0x30);
        LCD_DisplayChar(2,11,DIST%100/10 + 0x30);
        LCD_DisplayChar(2,12,DIST%10 + 0x30);
