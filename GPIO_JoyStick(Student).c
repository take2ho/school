...
{ 
 ...
 switch(KEY_Scan())
        {
        	case 0xFE00 : 	//SW0
                        Fram_Write(100,1);  // FRAM (0~8191)1번지에 1 저장 
	        break;
        	case 0xFD00 : 	//SW1
                        LCD_DisplayChar(2,0,Fram_Read(100)+0x30); //FRAM 100번지 저장된 data(1byte) 읽어 
                                                                                        // LCD에 표시
          	break;
        	case 0xFB00 : 	//SW2
                        Fram_Write(100,2);  // FRAM (0~8191)1번지에 1 저장 
	        break;
        	case 0xF700 : 	//SW3
                        LCD_DisplayChar(3,0,Fram_Read(100)+0x30); //FRAM 200번지 저장된 data(1byte) 읽어 
                                                                                        // LCD에 표시
          	break;
        }  // switch(KEY_Scan())  
